                ...
                @foreach($conversations as $conversation)
                    ...
                    >
                        <a href="#" class="shrink-0">
                            <x-avatar src="https://i.pravatar.cc/300?img={{ $conversation->getReceiver()->id }}" />
                        </a>

                        <aside class="grid grid-cols-12 w-full">
                            <a href="{{ route('chat.view', $conversation->id) }}" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
